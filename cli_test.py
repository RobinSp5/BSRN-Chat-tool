...
# Der CLI-Code (du kannst ihn auch in cli.py auslagern und importieren)
def print_help():
    print("""
Verfügbare Befehle:
...
# Dummy-Daten für Testlauf
if __name__ == "__main__":
    # Dummy-Kommunikationskanäle (du kannst später echte Prozesse anbinden)
    to_network = Queue()
    from_network = Queue()
    to_discovery = Queue()
